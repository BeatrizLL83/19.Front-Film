...
Todas las interacciones con la API se encapsularán en **_una única capa de repositorio_** siguiendo el patrón repositorio. Esta capa actuará como punto único de acceso a los datos y aislará al resto de la aplicación de los detalles técnicos de transporte, endpoints y formato de respuesta.
